...
class Diagram_model():
    ...
    def add_arrow(self, child, id, value, style):
        ...
        try:
            ...
            self.add_value_to_arrow(arrow, value, style, id, deprecated)
    ...
    def add_rhombus(self, child, id, value):
        rhombus = {}
        value_html_clean = clean_html_tags(value) if "value" in child.attrib else None

        try:
            # Check if the name of the rhombus is crossed out
            rhombus['deprecated'] = True if '<strike' in value else False
    ...
    def add_datatype_property(self, child, value, id, style, child2):
        datatype_property = {}
        ...
        for attribute_value in attribute_list:
            ...
            try:
                # Check if the name is crossed out
                attribute['deprecated'] = True if '<strike' in attribute_value else False
                # get the prefix:uri
    ...
    def add_class(self, value, id, child):
        ontology_class = {}
        # Check if the name of the box is crossed out
        ontology_class["deprecated"] = True if '<strike' in value else False
    ...
    def add_value_to_arrow(self, relation, value, style, id, deprecated):
