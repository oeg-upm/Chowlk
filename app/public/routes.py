...
def api():
    ...
    if request.method == "POST":
        ...
        try:
            ...
            return {'ttl_data': "", "errors": {'Server Error': {'message': 'Server error, review the input diagram'}}, 'new_namespaces': {}, 'xml_error_generated': False, 'xml_error_file': ""}
        ...
        return {'ttl_data': turtle_file_string, "errors": new_errors, "new_namespaces": new_namespaces, 'xml_error_generated': xml_error_generated, 'xml_error_file': xml_error_file}
