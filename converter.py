...
def main(diagram_path, output_path, format):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--format", type=str, default="ttl", help="the format of the ontology: ttl or xml")
    args = parser.parse_args()

    main(args.diagram_path, args.output_path, args.format)
